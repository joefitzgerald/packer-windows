...
wget -outfile $env:TEMP\docker-1.13.0-rc5.zip "https://test.docker.com/builds/Windows/x86_64/docker-1.13.0-rc5.zip"
Expand-Archive -Path $env:TEMP\docker-1.13.0-rc5.zip -DestinationPath $env:TEMP -Force
copy $env:TEMP\docker\*.exe $env:ProgramFiles\docker
Remove-Item $env:TEMP\docker-1.13.0-rc5.zip
