...
wget -outfile $env:TEMP\docker-1.13.0-rc4.zip "https://test.docker.com/builds/Windows/x86_64/docker-1.13.0-rc4.zip"
Expand-Archive -Path $env:TEMP\docker-1.13.0-rc4.zip -DestinationPath $env:TEMP -Force
