...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://download.virtualbox.org/virtualbox/5.0.20/VBoxGuestAdditions_5.0.20.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
